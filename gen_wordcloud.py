...
for i in polit_list:
    tweet_df[i] = pd.read_csv('/Users//divy//Desktop//Divy//PDPU//Sem-7//BDA//ECE143-Political-Sentiment-Analysis-master//data//'+i + '_tweets.csv')

def gen_wordcloud(name=None):
    '''
